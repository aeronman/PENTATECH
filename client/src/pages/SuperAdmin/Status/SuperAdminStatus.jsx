...
const StatusPage = () => {
  ...
  return (
    <div className="SuperAdminStatus1">
      <div className="SuperAdminStatus1-1">
        <SuperAdminSidebar />
      </div>
      <div className="SuperAdminStatus1-2">
        <div className="SuperAdminStatus1-2-1">
          <RegProfile />
        </div>
        ...
        <div className="SuperAdminStatus1-2-2">
